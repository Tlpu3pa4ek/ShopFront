        ...
        <div class="bg-white" style="border-radius: 56px;">
          <div class="w-full bg-surface-0 dark:bg-surface-900 py-10 px-8 sm:px-20" style="border-radius: 53px">
            <div class="text-center mb-8">
              ...
              <router-link to="/register" class="text-green-400 underline">Register</router-link>
            </div>
            ...
            <div>
              ...
              <label for="password1" class="block text-surface-900 dark:text-surface-0 font-normal text-xl mb-2 mt-4">Password</label>
              <input
                  v-model="password"
                  type="password"
                  placeholder="Password"
...
<!--                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Forgot password?</span>-->
              ...
              <button
                  @click="login"
                  class="w-full bg-green-400 text-white p-2 rounded-md hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-green-400"
              >
                Login
              </button>

              <p v-if="error.message" class="text-red-500 text-sm mt-2">
                {{error.message === 'Unauthorized'? 'Неверный логин или пароль!' : 'Ошибка авторизации!'}}
              </p>
            </div>
          </div>
        </div>
