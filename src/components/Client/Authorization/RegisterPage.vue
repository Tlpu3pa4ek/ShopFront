...
<!--      &lt;!&ndash; Поле для подтверждения пароля &ndash;&gt;-->
<!--      <input-->
...
<!--      &lt;!&ndash; Кнопка регистрации &ndash;&gt;-->
<!--      <button-->
<!--          @click="register"-->
...
<!--      &lt;!&ndash; Сообщение о несовпадении паролей &ndash;&gt;-->
...
<!--  </div>-->
  ...
  <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen overflow-hidden ">
    <div class="flex flex-col items-center justify-center" style="width: 60%">
      <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
        <div class="bg-white" style="border-radius: 56px;">
          <div class="w-full bg-surface-0 dark:bg-surface-900 py-12 px-32 mx-4" style="border-radius: 53px;">
            <div class="text-center mb-8">
              ...
              <router-link to="/login" class="text-green-400 underline">Have a Login</router-link>
            </div>

            <div>
              <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-normal mb-2 mt-2">Name</label>
              <input
                  v-model="name"
                  type="text"
                  placeholder="Name"
              ...
              <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-normal mb-2 mt-2">Email</label>
              <input
                  v-model="email"
                  type="email"
                  placeholder="Email"
                  class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400"
                  required
              />

              <label for="password1" class="block text-surface-900 dark:text-surface-0 font-normal text-xl mt-4">Password</label>
              <input
                  v-model="password"
                  type="password"
                  placeholder="Password"
              ...
              <label for="password2" class="block text-surface-900 dark:text-surface-0 font-normal text-xl mb-2 mt-4">Confirm Password</label>
              <input
                  v-model="password_confirmation"
                  type="password"
                  placeholder="Confirm Password"
              ...
              <button
                  @click="register"
                  class="w-full bg-green-400 text-white p-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-green-400"
              >
                Register
              </button>
