<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Автомойка будущего – удобство и качество в одном месте!</div>
            <span class="text-muted-color text-2xl">Всегда рядом, когда вам нужно!</span>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                ...
                <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Интуитивно понятный интерфейс</div>
                <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
                    >Забудьте о сложных формах и звонках. Запись на мойку занимает всего пару кликов. Выберите удобное время и подходящую услугу прямо в приложении.</span
                >
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                ...
                <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Гибкий график – адаптируется под вас</div>
                <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px"
                    >Утренние, дневные и вечерние сеансы доступны на любой день недели. Вы всегда сможете подобрать удобное время, даже если у вас плотный график.</span
                >
            </div>
