...
import TopbarWidget from "@/components/Client/Lending/TopbarWidget.vue";

export default {
  components: {TopbarWidget, PrimePreloader},
  data() {
    return {
      loading: true,
      userData: '',
...
<template>
  ...
  <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-0 lg:px-10 flex items-center justify-between relative lg:static">
    <TopbarWidget />
  </div>
    ...
    <div class="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden" style="margin-top: 3rem">
      ...
      <div class="bg-beige-100 p-8 flex flex-col items-center" style="background-color: #f5ede6;">
        <div class="avatar-container">
          <img v-if="!userData.photo" src="src/assets/images/user.def.photo.png" class="avatar1" alt="">
          <img v-if="userData.photo" :src="`http://localhost:8000/storage/${userData.photo}`" class="avatar" alt="">
